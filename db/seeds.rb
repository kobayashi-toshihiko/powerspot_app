...
Element.create(name: '地', descript: 'test', kami: 'test', personal: 'test', match_attr: 'test', better_job: 'test')
Element.create(name: '水', descript: 'test', kami: 'test', personal: 'test', match_attr: 'test', better_job: 'test')
Element.create(name: '火', descript: 'test', kami: 'test', personal: 'test', match_attr: 'test', better_job: 'test')
Element.create(name: '風', descript: 'test', kami: 'test', personal: 'test', match_attr: 'test', better_job: 'test')
Element.create(name: '空', descript: 'test', kami: 'test', personal: 'test', match_attr: 'test', better_job: 'test')
